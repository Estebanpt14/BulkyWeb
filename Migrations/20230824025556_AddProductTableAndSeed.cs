    ...
    public partial class AddProductTableAndSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Agatha Cristie", "Libro sobre ella", "C928341", 100000.0, 1200.0, 12832.0, 9823.0, "Ella" },
                    { 2, "Agatha Cristie", "Libro sobre el", "C928342", 110000.0, 11200.0, 12132.0, 9824.0, "El" },
                    { 3, "Agatha Cristie", "Wasd", "C928343", 1100.0, 120.0, 1832.0, 983.0, "Prueba" }
                });
        }
